...
In my experience with Skeleton, **I was more satisfied with the tool compared to SASS**. However, **I will not be using it for my Freedom Project as it is relatively similar to BootStrap** - another tool dedicated to web design which I will use already, with the features only being a miniture version.
...
My experience with A-Frame was ecstatic. The tool was pleasant to use and some of the challenges I faced were fun to solve along my way of tinkering. There were also moments where I felt   As for my tool selection, **I will be using A-Frame**.
